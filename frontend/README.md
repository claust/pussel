...
# For iOS simulator - specify the simulator name
...
To launch iOS simulator and run the app:

```bash
# One-line command to launch simulator and run app
flutter emulators --launch apple_ios_simulator && flutter run -d "iPhone SE (3rd generation)"
```
