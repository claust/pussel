...
import 'piece_selection_screen.dart';

/// Screen for managing a test puzzle (similar to PuzzleScreen but uses grid selection).
class TestPuzzleScreen extends StatefulWidget {
  const TestPuzzleScreen({
  ...
  @override
  State<TestPuzzleScreen> createState() => _TestPuzzleScreenState();
}

class _TestPuzzleScreenState extends State<TestPuzzleScreen> {
  ...
  Future<void> _addPuzzlePiece() async {
    ...
    try {
      ...
      setState(() => _isProcessingPiece = false);
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      title: Text('Test Puzzle (${widget.gridSize.displayName})'),
      actions: [
        IconButton(
