    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        }
        {
          ...
          value: '["https://pussel-frontend.azurewebsites.net", "http://localhost:3000", "https://pussel.example.net"]'
        }
        {
          name: 'PUBLIC_URL'
          value: 'https://pussel.example.net'
        }
      ]
    }
  }
...
resource existingCertificate 'Microsoft.Web/certificates@2021-02-01' existing = {
  name: 'pussel.example.net-pussel-backend-dev'
  scope: resourceGroup()
}
...
resource customDomainBinding 'Microsoft.Web/sites/hostNameBindings@2021-02-01' = {
  name: '${appService.name}/pussel.example.net'
  properties: {
