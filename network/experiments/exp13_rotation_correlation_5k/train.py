"""Training script for Rotation Correlation experiment with 5K puzzles.

This experiment repeats exp12 with the full dataset (~5000 puzzles)
to evaluate whether more diverse training data improves generalization.

Key changes from exp12:
- Training puzzles: 800 -> 4499
- Test puzzles: 200 -> 500

Target: Improve both position and rotation accuracy with more data
"""
...
def run_experiment(  # noqa: C901
    ...
    """
    print("\n" + "=" * 70)
    print("EXPERIMENT 13: ROTATION CORRELATION WITH 5K PUZZLES")
    print("=" * 70)
    print("Same architecture as exp12, but with expanded dataset:")
    print("  - Training puzzles: 4499 (was 800 in exp12)")
    print("  - Test puzzles: 500 (was 200 in exp12)")
    print("  - Goal: Improve generalization with more diverse data")
    print("-" * 70)
    ...
    results: dict[str, Any] = {
        "experiment": "exp13_rotation_correlation_5k",
        "n_train_puzzles": n_train_puzzles,
        "n_test_puzzles": n_test_puzzles,
