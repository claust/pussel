"""Visualization helpers for larger backbone cell classification experiment.
...
Identical to exp3's visualize.py - reused for consistency.
"""
...
def create_heatmap_overlay(
    ...
    if plt is not None:
        ...
        # Custom colormap: dark blue -> yellow -> red
        # Low probability = dark blue, medium = yellow, high = red
        colors = [(0.1, 0.1, 0.3), (1.0, 1.0, 0.0), (1.0, 0.0, 0.0)]  # dark blue, yellow, red
...
def create_grid_comparison(
    ...
    for i in range(n_samples):
        ...
        # Heatmap with custom colormap: dark blue -> yellow -> red
        from matplotlib.colors import LinearSegmentedColormap
        ...
        colors = [(0.1, 0.1, 0.3), (1.0, 1.0, 0.0), (1.0, 0.0, 0.0)]  # dark blue, yellow, red
        cmap = LinearSegmentedColormap.from_list("prob_heatmap", colors)
        ax_heatmap.imshow(heatmap, cmap=cmap, aspect="auto")
        ax_heatmap.axis("off")
