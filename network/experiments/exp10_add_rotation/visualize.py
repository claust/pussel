"""Visualization utilities for position + rotation prediction experiment.
...
def save_prediction_grid(
    ...
    fig.suptitle(
        f"Position + Rotation Predictions - Quad: {quad_acc:.1%}, Rot: {rot_acc:.1%}",
        fontsize=14,
    )
...
if __name__ == "__main__":
    print("Visualization utilities for exp10_add_rotation")
