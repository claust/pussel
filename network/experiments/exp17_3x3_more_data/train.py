"""Training script for 3x3 grid position prediction with more data.

Exp17: Scales up training data from 500 to 10,000 puzzles to reduce overfitting.
Based on exp16 architecture with ShuffleNetV2_x0.5 backbone.

Key changes from exp16:
- 10,000 training puzzles (was 500)
- Configurable cells_per_puzzle to control samples per epoch
- Checkpoint saving for best and last models
"""
...
def main(
    ...
    print("\n" + "=" * 70)
    print("EXPERIMENT 17: 3x3 GRID WITH MORE DATA")
    print("=" * 70)
    ...
    # Compile results
    results = {
        "experiment": "exp17_3x3_more_data",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Exp17: 3x3 grid with more data (10K puzzles)")
    parser.add_argument("--epochs", type=int, default=100, help="Training epochs")
    parser.add_argument("--n-train", type=int, default=10000, help="Training puzzles")
    parser.add_argument("--n-test", type=int, default=200, help="Test puzzles")
    parser.add_argument("--cells-per-puzzle", type=int, default=1, help="Cells per puzzle (1-9)")
