"""Visualization utilities for 3x3 grid experiment.
...
def save_prediction_grid(
    ...
    fig.suptitle(
        f"Exp16: 3x3 Grid - Cell: {cell_acc:.1%}, Rot: {rot_acc:.1%}",
        fontsize=14,
    )
...
def save_training_curves(
    ...
    plt.suptitle("Exp16: 3x3 Grid Training Curves", fontsize=14)
    plt.tight_layout()
    plt.savefig(output_path, dpi=150, bbox_inches="tight")
    plt.close()
...
if __name__ == "__main__":
    print("Visualization utilities for exp16_3x3_grid")
