"""Learning rate finder for exp16.
...
def plot_lr_finder(
    ...
    plt.suptitle("Learning Rate Finder - Exp16 (3x3 Grid)", fontsize=14)
    plt.tight_layout()
...
def main(
    ...
    print("\n" + "=" * 60)
    print("LEARNING RATE FINDER - Exp16 (3x3 Grid)")
    print("=" * 60)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Learning rate finder for exp16")
