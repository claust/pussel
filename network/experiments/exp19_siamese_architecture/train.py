"""Training script for 3x3 grid position prediction with 20K puzzles.

Exp18: Scales up training data from 10,000 to 20,000 puzzles to further improve
generalization. Based on exp17 architecture with ShuffleNetV2_x0.5 backbone.

Key changes from exp17:
- 20,000 training puzzles (was 10,000)
- 180,000 samples per epoch (was 90,000)
"""
...
def main(
    ...
    piece_size: int = 128,
    puzzle_size: int = 256,
    cells_per_puzzle: int = 9,
) -> dict[str, Any]:
    """Run 3x3 grid training with ShuffleNetV2_x0.5 and 20K puzzles.

    Args:
        epochs: Number of training epochs.
        n_train: Number of training puzzles (default: 20000).
    ...
    # Create data loader
    # num_workers=2 balances speed vs memory (4 workers caused OOM)
    ...
    # Compile results
    results = {
        "experiment": "exp18_3x3_20k_puzzles",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Exp18: 3x3 grid with 20K puzzles")
    parser.add_argument("--epochs", type=int, default=100, help="Training epochs")
    parser.add_argument("--n-train", type=int, default=20000, help="Training puzzles")
    parser.add_argument("--n-test", type=int, default=200, help="Test puzzles")
    parser.add_argument("--cells-per-puzzle", type=int, default=9, help="Cells per puzzle (1-9)")
    ...
    main(
        ...
        cells_per_puzzle=args.cells_per_puzzle,
    )
