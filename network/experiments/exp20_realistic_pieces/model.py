"""Model for 4x4 grid position prediction with ShuffleNetV2_x0.5 backbone.

Exp20: Same architecture as exp18, adapted for 4x4 grid (16 cells) with
realistic puzzle pieces.

Key features:
- Region extraction handles 4x4 grid
- predict_cell() method for 16-class cell prediction
