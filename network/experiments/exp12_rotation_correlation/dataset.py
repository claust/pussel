...
This module is largely the same as exp11 - the data loading and augmentation
strategy remains unchanged. The key innovation in exp12 is in the MODEL
architecture (rotation correlation), not the dataset.

Key features:
- Exp12 training: Random 1 rotation per quadrant = 4 samples per puzzle
- Exp12 testing: All 4 rotations for deterministic evaluation
"""
